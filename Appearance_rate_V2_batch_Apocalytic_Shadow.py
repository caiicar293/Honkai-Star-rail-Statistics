...
class HonkaiStatistics_V2_APOC_Batch:
    ...
    def _build_lazy_sequences(self):
        ...
        if self.node == 0 or self.node == "all":
            ...
            if self._has_starward_col and self.is_starward:
                n3 = _node_lf(3, "n3_Scores", "n3_max_ed")
                ...
                SELECT 
                    ...
                    n2.*,
                    n3.*,
                    (n1.n1_Scores + n2.n2_Scores + n3.n3_Scores) AS total_Scores,
                ...
                SELECT 
                    n1.*,
                    n2.*,
                    (n1.n1_Scores + n2.n2_Scores) AS total_Scores,
    ...
    def _process_combined_data(self, combined, char_cols, cons_cols, dps_names, char_to_index):
        ...
        # Character pairing — explode all node char columns
        char_pair_base = combined.select(
            ["uid", "version", "at_eidolon_level", "up_to_eidolon_level", "total_Scores"] + node_char_cols
        )
