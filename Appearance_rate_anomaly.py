...
class HonkaiStatistics_Anomaly:
    ...
    def _process_data(self):
        exempts = ["Kafka", "Jing Yuan", "Seele", "Jingliu", "Dan Heng • Imbibitor Lunae",
                   ...
                   "Firefly", "Yunli", "Jiaoqiu", "Feixiao", "Lingsha","Rappa","Sunday","Fugue","The Herta","Aglaea","Tribbie","Mydei","Castorice","Anaxa","Hyacine","Cipher","Phainon","Archer","Saber","Hysilens","Cerydra","Evernight","Dan Heng • Permansor Terrae","Cyrene","The Dahlia"]
